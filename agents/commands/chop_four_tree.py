...
from models.commands import ChopFourTreeReqData, ChopFourTreeResData
...
class ChopFourTreeCommand(Command[ChopFourTreeReqData, ChopFourTreeResData]):
    def __init__(self, agent_manager: 'AgentManager', replace_sapling: bool = True):
        super().__init__(agent_manager)
        self.replace_sapling = replace_sapling

    def format_data(self) -> ChopFourTreeReqData:
        return ChopFourTreeReqData(replaceSapling=self.replace_sapling)
